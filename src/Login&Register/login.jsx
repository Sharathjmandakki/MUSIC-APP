...
export default function Login() {
  ...
  const login = async (e) => {
    ...
    try {
      ...
      else if (response.data === "Artest") {
        navigate("/artest/", { replace: true })
